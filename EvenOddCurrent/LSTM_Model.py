...
class LSTM_Model(tf.keras.Model):
    def __init__(self):
        ...
        self.lstm_cell = LSTM_Cell(units=30)
     
        self.layer_list = [
            tf.keras.layers.RNN(self.lstm_cell, return_sequences=True, unroll=True),
    ...
    def train_step(self, x, target):
        ...
        self.metric_accuracy.update_state(target, prediction)
